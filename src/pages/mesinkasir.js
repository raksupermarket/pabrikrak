...
<p>Apa saja POS <a href="mesinkasir" title="mesin kasir">mesin kasir</a> system untuk digunakan ?? kami menyediakan dua variant mesin kasir dalam penggunaan nya dan anda dapat menambahkan divisi sesuai dengan permintaan yang nanti nya akan kami kalkulasikan anggaran biaya pos point of sale sesuai kebutuhan pembagian divisi.</p>
	  <img alt="mesin kasir" class="img-fluid rounded shadow shadow-lg" src="https://raksupermarket.github.io/img/TOUCHSCREEN6.png"/>
...
<a href="https://www.youtube.com/watch?v=NLxDbnyQ4r4" class="button" target="blank">Video</a>. <a href="https://raksupermarket.github.io/file/touchscreen.pdf" class="button" target="blank">Download</a>.
	  <img alt="meja kasir terbaru" class="img-fluid rounded shadow shadow-lg" src="https://raksupermarket.github.io/img/mesinkasironline-murah.png"/>
...
<a href="https://www.youtube.com/watch?v=cRKPNLRBTFU" class="button" target="blank">Video</a>. <a href="https://raksupermarket.github.io/file/portable.pdf" class="button" target="blank">Download</a>.
